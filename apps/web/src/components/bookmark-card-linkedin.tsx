...
interface BookmarkCardLinkedInProps {
  bookmark: BookmarkPost;
}

export function BookmarkCardLinkedIn({ bookmark }: BookmarkCardLinkedInProps) {
  ...
  const platformBadge = (
    <Badge variant="secondary" aria-label="Platform: LinkedIn">
      LinkedIn
    </Badge>
  );
