 ...
 * ```
 */
export function create_workflow_logger(context: WorkflowContext): Logger {
 ...
 */
export function log_workflow_start(
	logger: Logger,
 ...
 */
export function log_workflow_completion(
	logger: Logger,
	success: boolean,
	duration: number,
 ...
 */
export function log_step_start(logger: Logger, stepName: string): void {
 ...
 * @param result - Result summary
 */
export function log_step_completion(
	logger: Logger,
	stepName: string,
	duration: number,
	result?: Record<string, any>,
 ...
 * @param duration - Step execution time in milliseconds
 */
export function log_step_failure(
	logger: Logger,
	stepName: string,
	error: Error,
	duration: number,
