...
import type { IMediaMetadata, IUploadResult } from "../types";
...
export const storage_upload_service = restate.service({
	name: "storage_upload_service",
	handlers: {
		upload: async (
			ctx: restate.Context,
			input: IStorageUploadInput,
