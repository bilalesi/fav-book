import prisma, { type Prisma } from "@favy/db";
import type { ICollection } from "@favy/shared";
import { z } from "zod";
...
export const collections_router = {
	...
	addBookmark: protected_middleware
		.input(
			z.object({
	...
	remove_bookmark: protected_middleware
		.input(
			z.object({
				collectionId: z.string(),
				bookmarkId: z.string(),
