 ...
 */
export function retrieve_status_code_for_error(code: ErrorCode): number {
 ...
 */
export function create_error_response(
	code: ErrorCode,
	message: string,
	details?: Record<string, any>,
): IErrorResponse {
 ...
 */
export function sanitize_error_message(
	error: Error,
 ...
 */
export function map_error_to_app_error(error: unknown): AppError {
	// Already an AppError
